...
/// Note: A section contains a list of [Notice] objects that describe _potential issues_
/// after the route was calculated. If the list is non-empty, it is recommended to evaluate
/// possible violations against the requested route options and reject the route if deemed necessary.
...
Section sdk_routing_Section_fromFfi(Pointer<Void> handle) {
  ...
  if (instance is Section) return instance as Section;
