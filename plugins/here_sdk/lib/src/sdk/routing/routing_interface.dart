...
class RoutingInterface$Lambdas implements RoutingInterface {
  ...
  RoutingInterface$Lambdas(
    ...
    this.lambda_calculateScooterRoute = lambda_calculateScooterRoute;
...
int _RoutingInterface_calculateScooterRoute_static(int _token, Pointer<Void> waypoints, Pointer<Void> scooterOptions, Pointer<Void> callback) {

  try {
    (__lib.instanceCache[_token] as RoutingInterface).calculateScooterRoute(heresdk_routing_common_bindings_ListOf_sdk_routing_Waypoint_fromFfi(waypoints), sdk_routing_ScooterOptions_fromFfi(scooterOptions), sdk_routing_CalculateRouteCallback_fromFfi(callback));
  } finally {
    heresdk_routing_common_bindings_ListOf_sdk_routing_Waypoint_releaseFfiHandle(waypoints);
...
Pointer<Void> sdk_routing_RoutingInterface_toFfi(RoutingInterface value) {
  ...
  final result = _sdk_routing_RoutingInterface_create_proxy(
    ...
    Pointer.fromFunction<Uint8 Function(Uint64, Pointer<Void>, Pointer<Void>, Pointer<Void>)>(_RoutingInterface_calculateScooterRoute_static, __lib.unknownError),
...
RoutingInterface sdk_routing_RoutingInterface_fromFfi(Pointer<Void> handle) {
  ...
  if (instance is RoutingInterface) return instance as RoutingInterface;
